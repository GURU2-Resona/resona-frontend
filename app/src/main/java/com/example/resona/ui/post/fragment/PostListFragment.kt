...
class PostListFragment : Fragment(R.layout.fragment_post_list) {
    ...
    // ListPopupWindow를 사용하여 너비와 디자인 제어
    private fun showDropdownMenu(
        ...
        //너비 맞춤: 앵커(칩 버튼)의 너비와 동일하게 설정
        listPopupWindow.width = anchor.width

        // 둥근 배경 적용 (기존에 만드신 drawable 사용)
        ...
        // 팝업이 보여진 후 ListView에 접근하여 구분선 설정
