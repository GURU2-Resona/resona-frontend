...
@AndroidEntryPoint
class PostDetailShareFragment : Fragment(R.layout.fragment_post_detail_share) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ivShare?.setOnClickListener {
            shareToKakao(title, content, videoId, postId)
        }
    }

    private fun shareToKakao(title: String?, content: String?, videoId: String?, postId: Long) {
